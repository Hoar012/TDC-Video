...
def load_pretrained_model(
    ...
    **kwargs,
    ...
    if "cambrian" in model_name.lower():
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "qwen" in model_name.lower():
                from tdc.language_model.cambrian_qwen import CambrianConfig
            elif "llama" in model_name.lower():
                from tdc.language_model.cambrian_llama import CambrianConfig
    ...
    if "llava" in model_name.lower():
        ...
        if getattr(model.config, "audio_input", False):
            model.model.initialize_audio(None)
            model.model.audio_encoder.to(device=device, dtype=torch.float16)
